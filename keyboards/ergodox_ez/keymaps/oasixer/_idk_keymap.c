...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, ST_MACRO_0,     ST_MACRO_1,     KC_F16,         KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_LPRN,        KC_RPRN,        KC_TRANSPARENT, KC_DQUO,
  ...
  [8] = LAYOUT_ergodox_pretty(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, ST_MACRO_2,     KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, ST_MACRO_8,     KC_TRANSPARENT,
    KC_TRANSPARENT, ST_MACRO_3,     ST_MACRO_4,     KC_TRANSPARENT, ST_MACRO_5,     KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, ST_MACRO_9,     KC_TRANSPARENT, KC_TRANSPARENT,
    KC_TRANSPARENT, ST_MACRO_6,     KC_TRANSPARENT, ST_MACRO_7,     KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                                    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                                                    KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
    ...
    if (record->event.pressed) {
      SEND_STRING(SS_TAP(X_BSPACE) SS_DELAY(5) SS_TAP(X_BSPACE) SS_DELAY(5) SS_TAP(X_BSPACE));
    }
    break;
    case ST_MACRO_1:
    if (record->event.pressed) {
      SEND_STRING( SS_TAP(X_DELETE) SS_DELAY(5) SS_TAP(X_DELETE) SS_DELAY(5) SS_TAP(X_DELETE));
    }
    break;
    case ST_MACRO_2:
    if (record->event.pressed) { // E presssed -> [E]mail = kaelan.ms@gmail.com
      SEND_STRING(SS_TAP(X_K) SS_DELAY(10) SS_TAP(X_A) SS_DELAY(10) SS_TAP(X_E) SS_DELAY(10) SS_TAP(X_L) SS_DELAY(10) SS_TAP(X_A) SS_DELAY(10) SS_TAP(X_N) SS_DELAY(10) SS_TAP(X_DOT) SS_DELAY(10) SS_TAP(X_M) SS_DELAY(10) SS_TAP(X_S) SS_DELAY(10) SS_LSFT(SS_TAP(X_2)) SS_DELAY(10) SS_TAP(X_G) SS_DELAY(10) SS_TAP(X_M) SS_DELAY(10) SS_TAP(X_A) SS_DELAY(10) SS_TAP(X_I) SS_DELAY(10) SS_TAP(X_L) SS_DELAY(10) SS_TAP(X_DOT) SS_DELAY(10) SS_TAP(X_C) SS_DELAY(10) SS_TAP(X_O) SS_DELAY(10) SS_TAP(X_M));
    }
    break;
    case ST_MACRO_3:
    if (record->event.pressed) { // A pressed -> [A]ddress = 1535 Clarita Ave.
      SEND_STRING(SS_TAP(X_1) SS_DELAY(10) SS_TAP(X_5) SS_DELAY(10) SS_TAP(X_3) SS_DELAY(10) SS_TAP(X_5) SS_DELAY(10) SS_TAP(X_SPACE) SS_DELAY(10) SS_LSFT(SS_TAP(X_C)) SS_DELAY(10) SS_TAP(X_L) SS_DELAY(10) SS_TAP(X_A) SS_DELAY(10) SS_TAP(X_R) SS_DELAY(10) SS_TAP(X_I) SS_DELAY(10) SS_TAP(X_T) SS_DELAY(10) SS_TAP(X_A) SS_DELAY(10) SS_TAP(X_SPACE) SS_DELAY(10) SS_LSFT(SS_TAP(X_A)) SS_DELAY(10) SS_TAP(X_V) SS_DELAY(10) SS_TAP(X_E) SS_DELAY(10) SS_TAP(X_DOT));
    }
    break;
    case ST_MACRO_4:
    if (record->event.pressed) { // S pressed -> [S]tate = California
      SEND_STRING(SS_LSFT(SS_TAP(X_C)) SS_DELAY(10) SS_DELAY(10) SS_TAP(X_A) SS_DELAY(10) SS_TAP(X_L) SS_DELAY(10) SS_TAP(X_I) SS_DELAY(10) SS_TAP(X_F) SS_DELAY(10) SS_TAP(X_O) SS_DELAY(10) SS_TAP(X_R) SS_DELAY(10) SS_TAP(X_N) SS_DELAY(10) SS_TAP(X_I) SS_DELAY(10) SS_TAP(X_A));
    }
    break;
    case ST_MACRO_5:
    if (record->event.pressed) { // F pressed -> [F]irstname = Kaelan
      SEND_STRING(SS_LSFT(SS_TAP(X_K)) SS_DELAY(10) SS_TAP(X_A) SS_DELAY(10) SS_TAP(X_E) SS_DELAY(10) SS_TAP(X_L) SS_DELAY(10) SS_TAP(X_A) SS_DELAY(10) SS_TAP(X_N));
    }
    break;
    case ST_MACRO_6:
    if (record->event.pressed) { // Z pressed -> [Z]ip = 95130
      SEND_STRING( SS_DELAY(10) SS_TAP(X_9) SS_DELAY(10) SS_TAP(X_5) SS_DELAY(10) SS_TAP(X_1) SS_DELAY(10) SS_TAP(X_3) SS_DELAY(10) SS_TAP(X_0) SS_DELAY(10) SS_TAP(X_0) SS_DELAY(10) SS_TAP(X_0) SS_DELAY(10) SS_TAP(X_0));
    }
    break;
    case ST_MACRO_7:
    if (record->event.pressed) { // C pressed -> [C]ity = San Jose
      // SEND_STRING(SS_LSFT(TAP(X_S)) SS_DELAY(10) SS_TAP(X_A) SS_DELAY(10) SS_TAP(X_N) SS_DELAY(10) SS_TAP(X_SPACE) SS_DELAY(10) SS_LSFT(TAP(X_J)) SS_DELAY(10) TAP(X_O) SS_DELAY(10) TAP(X_S) SS_DELAY(10) TAP(X_E) SS_DELAY(10));
      SEND_STRING(SS_LSFT(SS_TAP(X_S)) SS_DELAY(10)
                  SS_TAP(X_A) SS_DELAY(10)
                  SS_TAP(X_N) SS_DELAY(10)
                  SS_TAP(X_SPACE) SS_DELAY(10)
                  SS_LSFT(SS_TAP(X_J)) SS_DELAY(10)
                  SS_TAP(X_O) SS_DELAY(10)
                  SS_TAP(X_S) SS_DELAY(10)
                  SS_TAP(X_E) SS_DELAY(10)
      );
    }
    break;
    case ST_MACRO_8:
    if (record->event.pressed) { // P presssed -> [P]hone = +16692451735
        // X_KP_PLUS... Instead of shift + X_EQUAL bc why not test this out? hehe
      SEND_STRING(SS_TAP(X_KP_PLUS) SS_DELAY(10) SS_TAP(X_1) SS_DELAY(10) SS_TAP(X_6) SS_DELAY(10) SS_TAP(X_6) SS_DELAY(10) SS_TAP(X_9) SS_DELAY(10) SS_TAP(X_2) SS_DELAY(10) SS_TAP(X_4) SS_DELAY(10) SS_TAP(X_5) SS_DELAY(10) SS_TAP(X_1) SS_DELAY(10) SS_TAP(X_7) SS_DELAY(10) SS_TAP(X_3) SS_DELAY(10) SS_TAP(X_5));
    }
    break;
    case ST_MACRO_9:
    if (record->event.pressed) { // L pressed -> [L]astname = Moffett-Steinke

      SEND_STRING(SS_LSFT(SS_TAP(X_M)) SS_DELAY(10) SS_TAP(X_O) SS_DELAY(10) SS_TAP(X_F) SS_DELAY(10) SS_TAP(X_F) SS_DELAY(10) SS_TAP(X_E) SS_DELAY(10) SS_TAP(X_T) SS_DELAY(10) SS_TAP(X_T) SS_DELAY(10) SS_TAP(X_MINUS) SS_DELAY(10) SS_LSFT(SS_TAP(X_S)) SS_DELAY(10) SS_TAP(X_T) SS_DELAY(10) SS_TAP(X_E) SS_DELAY(10) SS_TAP(X_I) SS_DELAY(10) SS_TAP(X_N) SS_DELAY(10) SS_TAP(X_K) SS_DELAY(10) SS_TAP(X_E));
    }
    break;
