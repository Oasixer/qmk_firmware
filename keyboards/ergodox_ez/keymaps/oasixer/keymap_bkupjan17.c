...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    ...
    KC_LEFT_SHIFT,  KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,           TG(1),                                          KC_PGDN,        KC_N,           KC_M,           KC_COMMA,       KC_DOT,         KC_SLASH,       KC_LEFT_CTRL,
    KC_TRANSPARENT, KC_TRANSPARENT, MO(6),          MO(5),          MO(3),                                                                                                          MO(4),          KC_LEFT_CTRL,   KC_F16,         KC_RABK,        KC_TRANSPARENT,
  ...
  [1] = LAYOUT_ergodox_pretty(
    ...
    KC_LEFT_CTRL,   KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, MO(11),                                         KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    KC_LEFT_SHIFT,  KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                                    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
  ...
  [11] = LAYOUT_ergodox_pretty(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    KC_TRANSPARENT, KC_1,           KC_2,           KC_3,           KC_BSPC,        KC_TAB,         KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    KC_TRANSPARENT, KC_4,           KC_5,           KC_6,           KC_0,           KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
    ...
    break;
    case ST_MACRO_7: // UHHHHHHHHHHHHHHHHHHHH caps + b doesn't do this anymore idk it seems to do grappler via END or something?
    ...
    break;
    case ST_MACRO_37: // LT2B + t pressed -> create jobapp in obsidian
    ...
    if (record->event.pressed) {
      ...
      SEND_STRING(
         ...
         /* search for # LogEnd */
         SS_TAP(X_SLASH) SS_DELAY(50) SS_LSFT(SS_TAP(X_3)) SS_DELAY(5) SS_TAP(X_SPACE) SS_DELAY(5) SS_LSFT(SS_TAP(X_L)) SS_DELAY(5) SS_TAP(X_O) SS_DELAY(5) SS_TAP(X_G) SS_DELAY(5) SS_LSFT(SS_TAP(X_E)) SS_DELAY(3) SS_TAP(X_N) SS_DELAY(3) SS_TAP(X_D) SS_DELAY(100) SS_TAP(X_ENTER) SS_DELAY(400)
         ...
         SS_TAP(X_SPACE) SS_DELAY(10) SS_TAP(X_P) SS_DELAY(100)
         ...
         SS_TAP(X_J)  SS_DELAY(5) SS_TAP(X_D) SS_DELAY(10) SS_TAP(X_D) SS_DELAY(200)
         /* delete the line after the position line */
         SS_TAP(X_D) SS_DELAY(10) SS_TAP(X_D) SS_DELAY(50)
         /* delete the line after the position line */
         SS_TAP(X_D) SS_DELAY(10) SS_TAP(X_D) SS_DELAY(100)
         // /* go up */
         SS_TAP(X_K)
         SS_DELAY(50)
         // ^
         ...
         // d0
         SS_TAP(X_D) SS_DELAY(10) SS_TAP(X_0) SS_DELAY(50)
//
         SS_LSFT(SS_TAP(X_D)) SS_DELAY(50)
         //
         // /* create new job task */
    ...
    break;
    case ST_MACRO_38: // LT2B + a pressed -> apply
    if (record->event.pressed) {
    ...
    break;
    case ST_MACRO_39: // LT2B + s pressed -> save
    if (record->event.pressed) {
      SEND_STRING(SS_LSFT(SS_TAP(X_0)) SS_DELAY(10) SS_TAP(X_SCOLON) SS_DELAY(10) SS_TAP(X_S));
    }
    break;
    case ST_MACRO_40: // LT2B + d pressed -> hide / delete job
    if (record->event.pressed) {
    ...
    break;
    case ST_MACRO_41: // LT2B + f pressed -> filters
    if (record->event.pressed) {
      SEND_STRING(SS_LSFT(SS_TAP(X_0)) SS_DELAY(100) SS_TAP(X_SCOLON) SS_DELAY(100) SS_TAP(X_F));
    }
    break;
    case ST_MACRO_42: // LT2B + c pressed -> close tab
    if (record->event.pressed) {
      SEND_STRING(SS_LCTL(SS_TAP(X_W)));
    }
    break;
    case ST_MACRO_43:  // LT2B + b pressed -> bookmarks panel
    if (record->event.pressed) {
    ...
    break;
    case ST_MACRO_48:   // LT2B + k pressed -> prev job
    if (record->event.pressed) {
      SEND_STRING(SS_LSFT(SS_TAP(X_0)) SS_DELAY(100) SS_TAP(X_SCOLON) SS_DELAY(100) SS_TAP(X_K));
    }
    break;
    case ST_MACRO_49:   // LT2B + l pressed -> focus right pane
    if (record->event.pressed) {
